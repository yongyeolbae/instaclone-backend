...
export namespace Prisma {
  ...
  */
  ...
  export type HashtagCountOutputTypeGetPayload<
    S extends boolean | null | undefined | HashtagCountOutputTypeArgs,
    U = keyof S
      > = S extends true
        ? HashtagCountOutputType
    : S extends undefined
    ? never
    : S extends HashtagCountOutputTypeArgs
    ?'include' extends U
    ? HashtagCountOutputType 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof HashtagCountOutputType ?HashtagCountOutputType [P]
  : 
     never
  } 
    : HashtagCountOutputType
  ...
  export type HashtagGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < PhotoGetPayload<S['include'][P]>>  :
        P extends '_count'
        ? HashtagCountOutputTypeGetPayload<S['include'][P]> : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        ? Array < PhotoGetPayload<S['select'][P]>>  :
        P extends '_count'
        ? HashtagCountOutputTypeGetPayload<S['select'][P]> : never
  } 
    : Hashtag
  : Hashtag
